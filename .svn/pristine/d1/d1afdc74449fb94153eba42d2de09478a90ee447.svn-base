...
<div class="mypage-body-con">
		<div class="body-sub-con">
			<div class="body-sub-title">
				리뷰 상세보기
				<div class="go-list ml-auto">
					<a class="btn btn-sm p-15" href="/consultantMyPage/myConsultReview">리뷰 목록</a>
				</div>
			</div>
...
<%-- 	<p> enterpriseVO => ${enterpriseVO } </p> --%>00000000
		...
		<pre style="min-height:60px">${fn:trim(consultReviewVO.reviewCntnt) }</pre>
