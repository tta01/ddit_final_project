	...
	<div class="ent-menu-wrap">
		<div class="cen" style="padding:0">
			<ul class="ent-menu">
				...
				<li class="active"><a href="/enterprise/${enterpriseVO.entNo }/recruit">채용 공고 <span class="list-length">${fn:length(recruitVOList) }</span></a></li>
...
<div class="cen">
	...
	<div class="recruit-sector">
		...
		<div class="recruit-filter">
			...
			<form name="filter" action="/enterprise/${enterpriseVO.entNo}/recruit" method="get">
			...
			<c:forEach var="recruitVO" items="${recruitVOList}">
				...
				<div class="recruit-item" onclick="window.location.href='/recruit/${recruitVO.recruitNo}/detail'">
					...
					<div class="recruit-item-mid">
						...
						<p class="rec-info">
							${recruitVO.recruitCareer } · ${recruitVO.recruitSkill }
						</p>
					</div>
...
<script type="text/javascript">
	...
	chkMagam.addEventListener("change", function(){
		if(chkMagam.checked == true){
			location.href="/enterprise/${enterpriseVO.entNo}/recruit?magam=true&sort=${param.sort}&scrollY=${param.scrollY}";
		}else{
			location.href="/enterprise/${enterpriseVO.entNo}/recruit?magam=false&sort=${param.sort}&scrollY=${param.scrollY}";
		}
	})
