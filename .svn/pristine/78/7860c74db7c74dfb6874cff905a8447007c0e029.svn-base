...
<div class="mypage-body-con">
	<div class="sub-title-area">
		<div class="body-sub-title">일반회원(제목 오는 부분)</div>
		<hr class="title-hr" />
	</div>
	<div class="body-sub-con">
		...
		<div class="page-main-box">
						...
						<div class="input_resume_basic photo_use_basic">
							<div class="set1">
								<input type="text" class="input_resume_name_kr" placeholder="이름"
									maxlength="15" value="${memberVO.memNm}">
							</div>
							<div class="set2">
								<div class="with_icon">
			...
			<form id="frm" name="frm" action="/consultantMyPage/resumeCreatePost"
				method="post" enctype="multipart/form-data">
				<!-- 회원정보 이후 이력서 작성 div 시작  -->
			<div class="inner-box">
				<div>
					이력서 제목 : <input type="text" name="resumeTitle" placeholder="이력서 제목을 입력하세요" onkeydown="handleEnter(event)">
				</div>
					<div class="rsm_hgroup">
						<div class="rsm-vertical-center">
							<h3 class="rsm_ttl">
					...
					<div style="margin-bottom: 80px;">
						<select name="resumeOccp" id="comCd" style="margin: 10px;">
							<option value="" selected>직군을 선택해주세요</option>
							<c:forEach var="comCodeInfoVOList" items="${comCodeInfoVOList}">
								<option name="" class="select-comCode"
									value="${comCodeInfoVOList.comCd}">${comCodeInfoVOList.comCdNm}</option>
							</c:forEach>
						</select> 
							...
							<div class="tagging_wrap">
								<div class="input_group frow_ty1 rtag_auto_list">
									<label for="resumeSkills"> <input type="text"
										class="tag_input" onkeydown="handleEnter(event)"
						...
						<div class="flex">
							<div class="career-left-div">
								<div class="group-date">
									<input class="input_resume"
										name="careerVOList[0].companyEntranceDt" type="date" /> <span>~</span>
									<input class="input_resume"
										name="careerVOList[0].companyLeaveDt" type="date" />
								</div>
							...
							<div class="career-right-div" id="career-right-divv">
								<div class="enterprise-name">
									<input class="input_resume_text1" placeholder="기업명" type="text"
										name="careerVOList[0].companyNm" value="">
								</div>
								<div class="enterprise-dept-position">
									<div class="enterprise-dept">
										<input class="input_ent_dept" placeholder="부서" type="text"
											name="careerVOList[0].companyDept" value="">
									</div>
									<div class="enterprise-position">
										<input class="input_ent_position" placeholder="직책" type="text"
											name="careerVOList[0].companyPosition" value="">
									</div>
								</div>
								<div class="enterprise-job-sal">
									<div>
										<input class="input_ent_job" placeholder="직무" type="text"
											name="careerVOList[0].companyJob" value="">
									</div>
									<div>
										<input class="input_ent_salary" placeholder="연봉(선택사항)"
											type="text" name="careerVOList[0].companySalary" value="">
									</div>
								</div>
								<div class="flexible_textarea">
									<textarea class="medit" name="careerVOList[0].companyDetCareer"
										placeholder="경력사항을 입력해보세요."></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="rsm_bottom">
						<div class="rsm_bottom__right">
							<label class="btn_check type-no-experience"> <input
								name="check_new" class="cscheck" type="checkbox" checked="">
								<span class="check_icon"></span> <span class="check_txt">신입입니다</span>
							</label>
						</div>
					</div>
					...
					<div class="certi-career-div" id="certi-career-div">
						...
						<div class="flex">
							<div class="certi-career-left-div">
								<div class="group-date">
									<input class="input_resume" name="resultVOList[0].resultStdt"
										type="date" /> <span>~</span> <input class="input_resume"
										name="resultVOList[0].resultEddt" type="date" />
								</div>
							</div>
							<div class="certi-career-right-div">
								<div class="enterprise-name">
									<input class="input_resume_text1" placeholder="성과명"
										name="resultVOList[0].resultTitle" type="text" value="">
								</div>
								<div class="flexible_textarea">
									<textarea class="medit" name="resultVOList[0].resultCntnt"
										placeholder="성과에 대한 설명을 입력하세요"></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="awards-career-div" id="awards-career-div">
						...
						<div class="flex">
							<div class="awards-career-left-div">
								<div class="group-date">
									<input class="input_resume" name="awardsVOList[0].awdDt"
										type="date" />
								</div>
							</div>
							<div class="awards-career-right-div" id="awards-career-right-div">
								<div class="enterprise-name">
									<input class="input_resume_text1" name="awardsVOList[0].awdNm"
										placeholder="활동 및 수상명" type="text" value="">
								</div>
								<div class="flexible_textarea">
									<textarea class="medit" name="awardsVOList[0].awdCntnt"
										placeholder="활동 및 수상에 대한 설명 입력"></textarea>
								</div>
								<div class="enterprise-name">
									<input class="input_resume_text1" name="awardsVOList[0].awdOrg"
										placeholder="수여 기관" type="text" value="">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="lang-career-right-div">
								...
								<div class="flex">
									<div class="lang-det-left-div">
										...
										<div class="group-date">
											<input class="input_resume"
												name="languageVOList[0].languageDTVOList[0].langDetailAcqDt"
												type="date" /> <span>~</span> <input class="input_resume"
												name="languageVOList[0].languageDTVOList[0].langDetailExpDt"
												type="date" />
										</div>
									</div>
									<div class="lang-det-right-div">
										<div class="enterprise-name">
											<input class="input_resume_text1"
												name="languageVOList[0].languageDTVOList[0].langDetailScore"
												placeholder="어학점수" type="text" value="">
										</div>
										<div class="flexible_textarea">
											<textarea class="medit"
												name="languageVOList[0].languageDTVOList[0].langDetailName"
					...
					<div class="flex" style="margin-top: 80px;">
						<button type="submit" class="btn btn-write ml-auto">이력서
							등록!</button>
					</div>
				</div>
