...
<div class="mypage-body-con">
	<div class="sub-title-area alert alert-success alert-dismissible fade sho alert alert-success alert-dismissible fade show">
		<div class="body-sub-title card-title">상담사 회원 관리 →
			<h3 class="card-title"
					>승인 요청</h3>
	...
	<div class="body-sub-con">
		<div class="card">
<form:form modelAttribute="memberVO" action="/admin/adminCounselorProposal" method="post">
	...
	<div class="biz-tab">
                    <a class="biz-tab__item biz-tab__item--active" href="/admin/adminCounselorProposal">전체 <span class="biz-tab__number"> ${totalCounsel}</span></a>
                    <a class="biz-tab__item " href="/admin/adminSuccess?sort=success">승인 <span class="biz-tab__number">${csCompleteCount}</span></a>
                    <a class="biz-tab__item " href="/admin/adminWaiting?sort=waiting">승인 대기<span class="biz-tab__number">${csWaitCount}</span></a>
                    <a class="biz-tab__item " href="/admin/adminFalse?sort=false">승인 취소<span class="biz-tab__number">${csFalseCount}</span></a>
     </div>
			<table class="counsel">
     			<colgroup>
		           <col style="width:10%">
			       ...
			       <thead>
				       ...
				       <tbody>
			       <c:forEach var="memberVO" items="${successCsVOList}" varStatus="stat">
				           <tr class="u_u">		
...
// 									        memYn.insertAdjacentHTML('beforeend', '<input type="button" class="Yncondition detailGo list-counting__applicants-btn" value="상태 변경"/>');
	            ...
	            function closeModal() {
	                ...
	                // 페이지 이동
	                window.location.href = "/admin/adminSuccess?sort=successl";
	            }
