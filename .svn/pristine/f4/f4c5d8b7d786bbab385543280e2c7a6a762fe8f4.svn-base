...
<script>
    ...
    $(document).ready(() => {
    	...
    	$("#modal-custom").iziModal({
            ...
            let request = $.ajax({
                url: "${pageContext.request.contextPath}/member/getEvents",
                type: "GET",
                dataType: "json"
            });
            ...
            function event_update(info) {
                ...
                //일정 수정시 서버로 요청
        	    $.ajax({
        	    	url: "${pageContext.request.contextPath}/member/updateEvent",
        	    	type: "post",
        	    	dataType: "json",
        	    	data: jsondata,
                    ...
                    select: function (arg) {
                    	...
                    	$('#addEventButton1').on('click',function(){
                    	    ...
                    	    if(eventTitle && startDateTime && endDateTime !=null){
                        	    ...
                        	    //일정 추가 -> 서버로 요청
                        	    $.ajax({
                        	    	url: "${pageContext.request.contextPath}/member/addEvent",
                        	    	type: "post",
                        	    	dataType: "json",
