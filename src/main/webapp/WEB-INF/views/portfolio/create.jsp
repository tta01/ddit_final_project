...
<div class="lectureCen">
	<div class="lectureBoard">
		<h1 class="lecture-main-tit">자기소개서 기본양식</h1>
		<div class="lec-h-div-line"></div>
		
		<form class="mt-20" name="frm" action="/portfolio/createForm?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
			<sec:csrfInput />
			...
			<div id="wrapper">
				...
				<textarea class="textarea" name="ptflGrowth" placeholder="성장과정을 입력해주세요." ></textarea>
	
				<p class="port-cntnt">지원동기</p>
				<textarea class="textarea" name="ptflMotive" placeholder="지원동기를 입력해주세요." ></textarea>
				...
				<textarea class="textarea" name="ptflAspirations" placeholder="입사 후 포부에 대해 서술해주세요."></textarea>
			</div>
