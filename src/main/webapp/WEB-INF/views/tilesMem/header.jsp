							...
							<div class="mypage-link">
								<sec:authorize access="hasRole('ROLE_MEMBER')">
									<ul>
										...
										<li><a href="/memberCalendar/calendar">일정관리</a></li>
										<li><a href="/memberInterest/myEnterpriseList">관심정보</a></li>
										<li><a href="/memberMyActivity/myBoardInquiry">활동내역</a></li>
								...
								<sec:authorize access="hasRole('ROLE_ENTERPRISE')">
									<ul>
										<li><a href="/enter/entmypage">개인 프로필</a></li>
										<li><a href="/entAccount/files">파일 보관함</a></li>
										<li><a href="/enter/recruit">공고 관리</a></li>
										<li><a href="/enter/application">지원자 현황</a></li>
										<li><a href="/enter/calendar">일정관리</a></li>
										<li><a href="/enter/jobOffer">맞춤 인재</a></li>
										<li><a href="/enter/review">리뷰 관리</a></li>
										<li><a href="/entPremium/itemList">프리미엄</a></li>
	...
	<sec:authorize access="hasRole('ROLE_ENTERPRISE')">
		<div class="mypage-top">
			<div class="cen">
				<ul class="mypage-top-menu">
					<li class="mypage-account"><a href="/memberAccount/profile">계정</a></li>
					<li class="mypage-files"><a href="/consultantMyPage/consultantLog">파일보관함</a></li>
					<li class="mypage-calendar"><a href="/memberCalendar/calendar">채용공고 관리</a></li>
					<li class="mypage-interested"><a href="/memberInterest/myEnterpriseList">지원자 관리</a></li>
					<li class="mypage-activity"><a href="/memberMyActivity/myBoardInquiry">일정 관리</a> </li>
					<li class="mypage-apply"><a href="/memberApplication/myApplicationList">맞춤 인재 추천</a></li>
					<li class="mypage-apply"><a href="/memberApplication/myApplicationList">리뷰 관리</a></li>
					<li class="mypage-premium"><a href="/memberPremium/consultantLog">프리미엄</a></li>
