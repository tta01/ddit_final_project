...
<div class="mypage-body-con">
	...
	<div class="body-sub-title">자기소개서 자유양식</div>
		<hr class="title-hr"/>
	</div>
		<div class="body-sub-con">
				
		<form class="mt-20" name="frm" action="/consultantMyPage/portfolioFreeCreateForm?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
			<sec:csrfInput />
